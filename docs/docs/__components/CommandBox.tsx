...
export const CommandBox = ({text})=>{
    ...
    return (
      ...
      <div className="top_box flex items-center">
        <div className="tab flex items-center"><TerminalIcon className="mr-4"/> <span className={css`margin-left:8px; font-size: 12; letter-spacing: .4px;`}>run in terminal</span></div>
      </div>
        <div id="command"
