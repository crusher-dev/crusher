...
const HoverOnElement = () => {
  return (
    <div style={{ padding: '6px 0px' }}>
      <div>
        <CodeBlock className={'language-javascript'}>
          {`// Select an element and hover on it
const element = await crusherSdk.page.waitForSelector("selector");
await element.hover();
...
const ScreenshotOfElement = () => {
  return (
    <div style={{ padding: '6px 0px' }}>
      <div>
        <CodeBlock className={'language-javascript'}>
          {`// Select an element and take screenshot
const element = await crusherSdk.page.waitForSelector("selector");
...
const KeyboardPageContainer = () => {
  return (
    <div style={{ padding: '6px 0px' }}>
      <div>
        <CodeBlock className={'language-javascript'}>
          {`// Typing something and copying all the text to clipboard
const { page } = crusherSdk;
  ...
  return (
    <div className={'flex items-center'} className={headerCss}>
      <div>
        ...
        <div className={headerDescriptionCss}>Extend your test with code steps</div>
      </div>
