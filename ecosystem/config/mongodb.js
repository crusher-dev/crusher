const MONGODB_CONFIG = {
	CONNECTION_STRING: process.env.MONGODB_CONNECTION_STRING ? process.env.MONGODB_CONNECTION_STRING : "mongodb://localhost:27017/crusher",
	...
	USERNAME: process.env.MONGODB_USERNAME ? process.env.MONGODB_USERNAME : '',
