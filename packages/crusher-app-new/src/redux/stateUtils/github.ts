...
export const getLinkedGithubRepos = (state): Array<iGithubIntegration> => state.github.connectedGithubRepos;
...
export const getReposForSelectedInstallation = (state) => {
	...
	return state.github.installationRepos[selectedInstallation.value] ? state.github.installationRepos[selectedInstallation.value] : null;
};
