...
export const getProjects = (state: any): Array<iAllProjectsItemResponse> => state.projects.allProjects;
...
export const getProjectMembers = (projectId: number) => (state: any) => (state.projects.members[projectId] ? state.projects.members[projectId] : []);
