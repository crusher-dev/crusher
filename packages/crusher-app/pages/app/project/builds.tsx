...
import { WithSidebarLayout } from "../../../src/hoc/withSidebarLayout";
import { Pagination } from "../../../src/components/Pagination";
import WithSession from "../../../src/hoc/withSession";
import { redirectToFrontendPath } from "../../../src/utils/router";
import { getCookies } from "../../../src/utils/cookies";
import { getAllJobsOfProject } from "../../../src/services/job";
import React, { useRef, useState } from "react";
import { useSelector } from "react-redux";
import { getSelectedProject } from "../../../src/redux/stateUtils/projects";
import { cleanHeaders } from "../../../src/utils/backendRequest";
...
function ProjectBuilds(props) {
	...
	// 	} else {
	// 		setIsLoading(true);
	// 		getAllJobsOfProject(selectedProjectId, currentPage).then((builds) => {
	// 			setProjectBuilds(builds);
	// 			setIsLoading(false);
	// 		});
	// 	}
	// }, [selectedProjectId]);
