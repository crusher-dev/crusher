			...
			<div className={"flex justify-center"}>
				<div className={"mt-84 flex flex-col items-center"}>
					...
					<div css={overlayContainer} className={"mt-36 pt-36 pl-32 pr-32 pb-60"}>
						...
						<div className={"flex justify-between align-baseline mb-20"}>
							<Text weight={500} fontSize={14} color={"#E7E7E7"}>
								{" "}
								Login with email
							</Text>

							<Text weight={400} fontSize={11.5} color={"#E7E7E7"}>
								{" "}
								Forgot password{" "}
							</Text>
						</div>
