	...
	})(
		{
				...
				function (t, e, n) {
						...
						return [
							100 *
								(0.4124 *
									...
									0.1805 *
										(i = 0.04045 < i ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92)),
					...
					function d(t) {
						...
						return (
							...
							(a /= 108.883),
							(n =
								0.008856 < (n /= 95.047) ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116),
							[
								116 * (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) -
									16,
								500 * (n - i),
								200 *
									(i - (a = 0.008856 < a ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116)),
							]
						);
					}
					function h(t) {
					...
					function v(t) {
						...
						return (
							...
							[
								...
								500 * (e - n),
								200 *
									(n - (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116)),
							]
						);
					}
					function y(t) {
					...
					(e = this),
						(n = function () {
							...
							function n(a, r) {
								...
								return m(function () {
									if (
										(null != c.deprecationHandler && c.deprecationHandler(null, a), o)
									) {
							...
							B('H', ['HH', 2], 0, 'hour'),
								...
								B('hmmss', 0, 0, function () {
									return (
										'' + $t.apply(this) + W(this.minutes(), 2) + W(this.seconds(), 2)
									);
								}),
								B('Hmm', 0, 0, function () {
									...
									t &&
										((n = u(e) ? ue(t) : le(t, e))
											...
											: 'undefined' != typeof console &&
											  console.warn &&
											  console.warn(
													'Locale ' + t + ' not found. Did you forget to resources it?',
											  )),
									te._abbr
								);
							}
								...
								update: function (n) {
									...
									if (c < 2 * Math.PI) {
										var f = a.rotation % (2 * Math.PI),
											g =
												(f += 2 * Math.PI * (f >= Math.PI ? -1 : f < -Math.PI ? 1 : 0)) + c,
											m = Math.cos(f),
											p = Math.sin(f),
											v = Math.cos(g),
											b = Math.sin(g),
											...
											_ =
												(f <= -Math.PI && -Math.PI <= g) || (f <= Math.PI && Math.PI <= g),
											k =
												(f <= 0.5 * -Math.PI && 0.5 * -Math.PI <= g) ||
									...
									(t.borderWidth = i.getMaxBorderWidth(d.data)),
										...
										(i.outerRadius =
											t.outerRadius - t.radiusLength * i.getRingIndex(i.index)),
								...
								updateElement: function (t, e, n) {
									...
									void 0 !== l.radius &&
										...
										(t._model = {
											...
											radius:
												s.radius || g.valueAtIndexOrDefault(l.pointRadius, e, f.radius),
											pointStyle:
												s.pointStyle ||
						...
						(e.exports = {
							...
							startDigest: function () {
								var t = this,
									...
									n = 0;
								1 < t.dropFrames &&
									((n = Math.floor(t.dropFrames)), (t.dropFrames = t.dropFrames % 1)),
									t.advance(1 + n);
								var i = Date.now();
							...
							c.extend(u.prototype, {
								...
								render: function (t) {
									...
									if (!1 !== g.notify(e, 'beforeRender')) {
										...
										if (
											a &&
											((void 0 !== n && 0 !== n) || (void 0 === n && 0 !== a.duration))
										) {
											var o = new s({
					...
					e.exports = function () {
						...
						(g.configMerge = function () {
							...
							(g.longestText = function (e, t, n, i) {
								...
								i.font !== t &&
									((a = i.data = {}), (r = i.garbageCollect = []), (i.font = t)),
									(e.font = t);
								var o = 0;
								g.each(n, function (t) {
							...
							(g.color = i
								? function (t) {
										return (
											t instanceof CanvasGradient && (t = a.global.defaultColor), i(t)
										);
								  }
								: function (t) {
					...
					e.exports = {
						modes: {
							...
							dataset: function (t, e, n) {
								...
								return (
									0 < r.length && (r = t.getDatasetMeta(r[0]._datasetIndex).data), r
								);
							},
							'x-axis': function (t, e) {
						...
						(e.exports = i.extend({
							...
							update: function (t, e, n) {
								...
								for (
									...
									(o = r[i]),
										(l = s[i]) ? (l.label = o) : s.push((l = { label: o, major: !1 }));
								return (
									(u._ticks = s),
			...
			36: [
				function (t, e, n) {
					...
					function o(t, e) {
						return (
							e && (R.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)), t
						);
					}
					function s(t) {
						...
						a = {
							...
							easeInElastic: function (t) {
								...
								return 0 === t
									...
									: (n || (n = 0.3),
									  (e =
											i < 1 ? ((i = 1), n / 4) : (n / (2 * Math.PI)) * Math.asin(1 / i)),
									  -i *
											Math.pow(2, 10 * (t -= 1)) *
							...
							e = i.extend({
								...
								handleTickRangeOptions: function () {
									...
									(t.min = n(e.min, t.min)),
										...
										null === t.max &&
											(t.max =
												0 !== t.min ? Math.pow(10, Math.floor(c.log10(t.min)) + 1) : 10),
										null === t.minNotZero &&
											(0 < t.min
												? (t.minNotZero = t.min)
												: t.max < 1
					...
					e.exports = function () {
						var t = i.extend({
							...
							getPixelForOffset: function (t) {
								...
								return (
									i +
									(n * (e._offsets.left + a)) / (e._offsets.left + 1 + e._offsets.right)
								);
							},
							...
							getLabelWidth: function (t) {
								var e = this.options.ticks,
									...
									r = Math.sin(i);
								return (
									n * a + p.valueOrDefault(e.fontSize, o.global.defaultFontSize) * r
								);
							},
