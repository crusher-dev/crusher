...
(function (h) {
	...
	function wb(a, b) {
		var c = ta(a, b),
			...
			f =
				b.iTotalDisplayRecords !== k ? b.iTotalDisplayRecords : b.recordsFiltered;
		if (d) {
		...
		for (e in b)
			b.hasOwnProperty(e) &&
				...
				h.isPlainObject(d)
					...
					: (a[e] =
							c && 'data' !== e && 'aaData' !== e && h.isArray(d) ? d.slice() : d));
		return a;
	}
	function Wa(a, b, c) {
		h(a)
	...
	u('tables().containers()', 'table().containers()', function () {
		return this.iterator(
			'table',
			function (a) {
	...
	o('ajax.url().resources()', function (a, b) {
		return this.iterator('table', function (c) {
			Tb(c, !1 === b, a);
		});
	});
