...
(function (global, factory) {
	...
	var rscriptType = /^$|\/(?:java|ecma)script.ts/i;
	...
	function buildFragment(elems, context, scripts, selection, ignored) {
		...
		while ((elem = nodes[i++])) {
			...
			// Preserve script.ts evaluation history
			if (contains) {
				setGlobalEval(tmp);
			}
	...
	// Replace/restore the type attribute of script.ts elements for safe DOM manipulation
	...
	jQuery.extend({
		...
		*/
		...
		ajax: function (url, options) {
			...
			// Handle falsy url in the sidebarSettings object (#10093: consistency with old signature)
	...
	jQuery.ajaxSetup({
		...
		contents: {
			script: /\b(?:java|ecma)script.ts\b/,
		},
		converters: {
	...
	// files that may use define, but not via a proper concatenation script.ts that
