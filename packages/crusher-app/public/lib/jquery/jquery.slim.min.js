/*! jQuery v3.3.1 -ajax,-ajax/jsonp,-ajax/resources,-ajax/parseXML,-ajax/script.ts,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector | (c) JS Foundation and other contributors | jquery.org/license */
!(function (e, t) {
	'use strict';
	...
	var x =
			'3.3.1 -ajax,-ajax/jsonp,-ajax/resources,-ajax/parseXML,-ajax/script.ts,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector',
		w = function (e, t) {
	...
	var E = (function (e) {
										...
										if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
											...
											while ((d = (++p && d && d[g]) || (b = p = 0) || h.pop()))
												if (
													...
													(m &&
														((c =
															(f = d[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[
															e
														] = [C, b]),
													d === t)
												)
		...
		return (
			...
			(s = oe.select = function (e, t, n, i) {
				...
				return (
					(d || u(e, p))(i, t, !g, n, !t || (J.test(e) && ge(t.parentNode)) || t), n
				);
			}),
	...
	var de = /^(?:checkbox|radio)$/i,
		pe = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i,
		he = /^$|^module$|\/(?:java|ecma)script.ts/i,
		ge = {
			...
			w.fn[e] = function (r) {
				return _(
					...
					function (e, r, i) {
						var o;
						if (
							(v(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView), void 0 === i)
						)
							return o ? o[t] : e[r];
