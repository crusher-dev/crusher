!(function (e, a) {
	...
	function Je(e) {
		...
		return (
			e < 100 && 0 <= e && isFinite(a.getUTCFullYear()) && a.setUTCFullYear(e), a
		);
	}
	function Ne(e, a, t) {
		var s = 7 + a - t;
			...
			e &&
				((t = o(a) ? oa(e) : ia(e, a))
					...
					: 'undefined' != typeof console &&
					  console.warn &&
					  console.warn(
							'Locale ' + e + ' not found. Did you forget to resources it?',
					  )),
			ea._abbr
		);
	}
					...
					e._w &&
						...
						(function (e) {
							...
							if (null != (a = e._w).GG || null != a.W || null != a.E)
								(d = 1),
									(r = 4),
									(t = ua(a.GG, e._a[he], Ie(Ha(), 1, 4).year)),
									(s = ua(a.W, 1)),
			...
			24 === e._a[Ye] &&
				...
				(e._d = (e._useUTC
					...
					: function (e, a, t, s, n, d, r) {
							...
							return (
								e < 100 && 0 <= e && isFinite(_.getFullYear()) && _.setFullYear(e), _
							);
					  }
				).apply(null, r)),
	...
	function Ea(e, t) {
		I(e, 0, 0, function () {
			var e = this.utcOffset(),
				a = '+';
			return (
				e < 0 && ((e = -e), (a = '-')), a + F(~~(e / 60), 2) + t + F(~~e % 60, 2)
			);
		});
	}
	Ea('Z', ':'),
	...
	function Ka(e, a, t, s) {
		...
		e.isValid() &&
			((s = null == s || s),
			r && We(e, Se(e, 'Month') + r * t),
			d && be(e, 'Date', Se(e, 'Date') + d * t),
	...
	function on(e, a, t, s) {
		...
		return 1 === e
			? n + dn(0, a, t[0], s)
			: a
			? n + (rn(e) ? _n(t)[1] : _n(t)[0])
			: s
			? n + _n(t)[1]
			: n + (rn(e) ? _n(t)[1] : _n(t)[2]);
	}
	l.defineLocale('lt', {
		months: {
		...
		translate: function (e, a, t) {
			...
			return 1 === t.length
				? a
					? s[0]
					: s[1]
				: e + ' ' + hn.correctGrammaticalCase(e, s);
		},
	};
	function Ln(e, a, t, s) {
		switch (t) {
	...
	var Tn = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split(
			'_',
		),
	...
	var Hn = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split(
			'_',
		),
	...
	var On = 'stycze\u0144_luty_marzec_kwiecie\u0144_maj_czerwiec_lipiec_sierpie\u0144_wrzesie\u0144_pa\u017adziernik_listopad_grudzie\u0144'.split(
			'_',
		),
		Wn = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrze\u015bnia_pa\u017adziernika_listopada_grudnia'.split(
			'_',
		);
	function En(e) {
	...
	var In = 'janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december'.split(
			'_',
		),
		...
		translate: function (e, a, t) {
			...
			return 1 === t.length
				? a
					? s[0]
					: s[1]
				: e + ' ' + Kn.correctGrammaticalCase(e, s);
		},
	};
