...
(function (global, factory) {
	...
	function loadLocale(name) {
		var oldLocale = null;
		// TODO: Find a better way to register and resources all the locales in Node
		if (
			!locales[name] &&
	...
	// This function will resources locale and then set the global locale.  If
		...
		if (key) {
			...
			if (data) {
				...
				if (typeof console !== 'undefined' && console.warn) {
					...
					console.warn(
						'Locale ' + key + ' not found. Did you forget to resources it?',
					);
				}
			}
		}
