...
!(function (t, e) {
	...
	return (function (t) {
				...
				var r = Object.keys(n.modules).concat(Object.keys(e.modules)),
					o = r.reduce(function (t, e) {
						...
						return (
							null == n
								? P.error(
										'Cannot resources ' + e + ' module. Are you sure you registered it?',
								  )
								: (t[e] = n.DEFAULTS || {}),
							t
						);
				...
				S = (function () {
					function t(e) {
						...
						if (
							...
							return P.error('Invalid Quill containers', e);
								...
								value: function (t) {
									...
									if (
										...
										if ('function' == typeof Event)
											...
											'object' === ('undefined' == typeof Event ? 'undefined' : l(Event))
										) {
								...
								value: function (t) {
									...
									if (e > 0) {
										...
										var d = l.position(s, !0),
											y = a(d, 2);
										return (
											(r = y[0]), (s = y[1]), f.setEnd(r, s), f.getBoundingClientRect()
										);
									}
									var v = 'left',
										b = void 0;
						...
						l(e, [
							...
							},
							{
								...
								value: function (t, n) {
									...
									r &&
										('line' === r.tagName ? (r.style.stroke = o) : (r.style.fill = o));
								},
							},
						]),
						e
		...
		function (t, e, n) {
			...
			if (
				(r.classList.toggle('test-class', !1), r.classList.contains('test-class'))
			) {
				...
				Array.prototype.find ||
					Object.defineProperty(Array.prototype, 'find', {
						value: function (t) {
							...
							for (
								var e, n = Object(this), r = n.length >>> 0, o = arguments[1], i = 0;
								i < r;
								i++
							)
						...
						c(t, [
							...
							},
							{
								...
								value: function (t, e) {
									...
									null != i &&
										((a =
											i instanceof g.default ? i.newlineIndex(l) - l + 1 : i.length() - l),
										(s = i
											.delta()
											.slice(l, l + a - 1)
											.insert('\n')));
				...
				(o.prototype.removeListener = function (t, e, r, o) {
					...
					if (a.fn)
						...
						for (var s = 0, u = [], c = a.length; s < c; s++)
							(a[s].fn !== e || (o && !a[s].once) || (r && a[s].context !== r)) &&
								u.push(a[s]);
						u.length
		...
		function (t, e, n) {
							...
							[
								{
									...
									value: function (t) {
										return t.tagName === this.tagName
											? void 0
											: u(e.__proto__ || Object.getPrototypeOf(e), 'formats', this).call(
													this,
													t,
											  );
									},
			...
			var b = (function (t) {
				function e(t) {
					...
					return (
						t.addEventListener('touchstart', r), t.addEventListener('mousedown', r), n
					);
				}
				return (
					a(e, t),
					s(e, null, [
						{
							...
							value: function (t) {
								var n = 'ordered' === t ? 'OL' : 'UL',
									r = u(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(
										this,
										n,
									);
								return (
						...
						l(e, null, [
							{
								...
								value: function (t) {
									return 'super' === t
										...
										: a(e.__proto__ || Object.getPrototypeOf(e), 'create', this).call(
												this,
												t,
										  );
								},
							...
							[
								{
									...
									value: function (t) {
										...
										return (
											'string' == typeof t && n.setAttribute('src', this.sanitize(t)), n
										);
									},
								},
								{
				...
				k = (function (t) {
					function e(t, n) {
						...
						if (!(r.container instanceof HTMLElement)) {
							var a;
							return (
								(a = x.error('Container required for toolbar', r.options)), l(r, a)
							);
						}
						return (
								...
								value: function (t) {
									t.container.classList.add('ql-snow'),
										...
										t.container.querySelector('.ql-link') &&
											this.quill.keyboard.addBinding({ key: 'K', shortKey: !0 }, function (
												e,
												n,
											) {
