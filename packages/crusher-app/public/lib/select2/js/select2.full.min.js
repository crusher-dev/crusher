/*! Select2 4.0.6-rc.1 | https://github.com/select2/select2/blob/master/LICENSE.md */ !(function (
	...
	'function' == typeof define && define.amd
		...
		? (module.exports = function (b, c) {
				return (
					void 0 === c &&
						(c =
							'undefined' != typeof window ? require('jquery') : require('jquery')(b)),
					a(c),
					c
				);
		  })
	...
	var b = (function () {
			...
			return (
							...
							(p = function (a, b) {
								...
								(n = function (a, c, d, f) {
									var h,
										...
										x = typeof d;
									if (
										((f = f || a), (t = l(f)), 'undefined' === x || 'function' === x)
									) {
										for (
						...
						(c.Decorate = function (a, c) {
							...
							for (
								var j = function (a) {
										...
										return function () {
											return (
												Array.prototype.unshift.call(arguments, b), e.apply(this, arguments)
											);
										};
									},
									k = 0;
						...
						return (
							...
							(d.prototype._attachCloseHandler = function (c) {
								a(document.body).on('mousedown.select2.' + c.id, function (c) {
									var d = a(c.target),
										e = d.closest('.select2');
									a('.select2.select2-containers--open').each(function () {
				...
				b.define('select2/data/select', ['./base', '../utils', 'jquery'], function (
					a,
					b,
					c,
				) {
				...
				b.define('select2/data/ajax', ['./array', '../utils', 'jquery'], function (
					a,
					b,
					c,
				) {
				...
				b.define('select2/dropdown/infiniteScroll', ['jquery'], function (a) {
					...
					return (
						...
						(b.prototype.createLoadingMore = function () {
							var b = a(
									'<li class="select2-results__option select2-results__option--resources-more"role="treeitem" aria-disabled="true"></li>',
								),
				...
				b.define('select2/dropdown/attachBody', ['jquery', '../utils'], function (
					a,
					b,
				) {
					function c(b, c, d) {
					...
					return (
						...
						(c.prototype.position = function (a, b, c) {
							b.attr('class', c.attr('class')),
								...
								b.addClass('select2-containers--open'),
				...
				b.define('select2/dropdown/minimumResultsForSearch', [], function () {
					...
					return (
						(b.prototype.showSearch = function (b, c) {
							return (
								!(a(c.data.results) < this.minimumResultsForSearch) && b.call(this, c)
							);
						}),
						b
					);
						...
						return (
							...
							(e.prototype._registerEvents = function () {
								...
								this.on('open', function () {
									a.$container.addClass('select2-containers--open');
								}),
									this.on('close', function () {
										a.$container.removeClass('select2-containers--open');
									}),
									this.on('enable', function () {
										a.$container.removeClass('select2-containers--disabled');
									}),
									this.on('disable', function () {
										a.$container.addClass('select2-containers--disabled');
									}),
									this.on('blur', function () {
										a.$container.removeClass('select2-containers--focus');
									}),
							...
							(e.prototype.render = function () {
								var b = a(
									'<span class="select2 select2-containers"><span class="selection"></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>',
								);
								return (
									b.attr('dir', this.options.get('dir')),
									(this.$container = b),
									this.$container.addClass(
										'select2-containers--' + this.options.get('theme'),
									),
				...
				b.define('select2/compat/inputData', ['jquery', '../utils'], function (
					a,
					b,
				) {
					function c(a, b, c) {
					...
					return (
						(a.prototype.position = function (a, b, c) {
							c.find('.dropdown-wrapper').append(b),
								...
								c.addClass('select2-containers--below');
						}),
						a
					);
				}),
