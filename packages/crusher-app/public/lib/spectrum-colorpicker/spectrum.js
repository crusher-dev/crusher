...
(function (factory) {
	...
	var defaultOpts = {
		...
		markup = (function () {
			...
			return [
				"<div class='sp-containers sp-hidden'>",
				"<div class='sp-palette-containers'>",
				"<div class='sp-palette sp-thumb sp-cf'></div>",
				"<div class='sp-palette-button-containers sp-cf'>",
				"<button type='button' class='sp-palette-toggle'></button>",
				'</div>',
				'</div>',
				"<div class='sp-picker-containers'>",
				...
				'</div>',
				"<div class='sp-input-containers sp-cf'>",
				"<input class='sp-input' type='text' spellcheck='false'  />",
				'</div>',
				"<div class='sp-initial sp-thumb sp-cf'></div>",
				"<div class='sp-button-containers sp-cf'>",
	...
	function spectrum(element, o) {
		...
		var doc = element.ownerDocument,
			...
			pickerContainer = container.find('.sp-picker-containers'),
		...
		function initialize() {
			...
			toggleButton.bind('click.spectrum', function (e) {
				...
				// The 'applyOptions' function puts the whole containers back into place
