...
export function AddSVG(props: any) {
	return (
...
export function TraySVG(props: any) {
	return (
...
export function LayoutSVG(props: any) {
	return (
...
export function ReportSVG(props: any) {
	return (
...
export function HelpSVG(props: any) {
	return (
...
export function PlaySVG(props: any) {
	return (
...
export function AppleSVG(props: any) {
	const { variant } = props;
...
export function FullScreenSVG(props: any) {
	return (
		<svg width={"12rem"} height={"12rem"} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function CompleteStatusIconSVG(props: any) {
...
export function NewTabSVG(props: any) {
	return (
...
export function Slash(props: any) {
	return (
...
export function NewPeople(props: any) {
	return (
	...
	return (
		<svg width={17} height={17} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M8.5 1.594a6.906 6.906 0 100 13.812 6.906 6.906 0 000-13.812zm.375 3.874a.531.531 0 00-.75 0L6 7.593a.531.531 0 10.75.751L7.97 7.126v4.03a.531.531 0 101.062 0v-4.03l1.219 1.218a.531.531 0 10.75-.75L8.875 5.467z"
				fill="#5F5F5F"
			/>
		</svg>
	);
	...
	return (
		<svg width={14} height={14} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M10.914 8.092a4.265 4.265 0 01-1.048 1.892c-.503.523-1.129.9-1.816 1.092a3.894 3.894 0 01-2.096 0 4.015 4.015 0 01-1.816-1.092l-.23-.238H5.7c.147 0 .287-.06.39-.169a.588.588 0 00.163-.407.588.588 0 00-.162-.407.541.541 0 00-.39-.168H2.575a.541.541 0 00-.39.168.588.588 0 00-.163.407v3.255c0 .152.059.299.162.406a.541.541 0 00.39.169c.147 0 .288-.06.391-.168a.588.588 0 00.162-.407V10.56l.228.238a5.111 5.111 0 002.311 1.39 4.955 4.955 0 002.669 0 5.111 5.111 0 002.31-1.39 5.427 5.427 0 001.335-2.407.597.597 0 00-.055-.437.556.556 0 00-.335-.269.533.533 0 00-.42.057.573.573 0 00-.257.35v0zm.906-2.856a.587.587 0 00.161-.406V1.575a.588.588 0 00-.162-.406.541.541 0 00-.39-.169.541.541 0 00-.39.169.588.588 0 00-.163.406V3.44l-.228-.237a5.11 5.11 0 00-2.31-1.39 4.955 4.955 0 00-2.67 0 5.11 5.11 0 00-2.31 1.39A5.427 5.427 0 002.023 5.61a.598.598 0 00.047.446.57.57 0 00.339.275.53.53 0 00.426-.061.561.561 0 00.255-.362 4.264 4.264 0 011.048-1.892c.502-.524 1.129-.901 1.816-1.093a3.893 3.893 0 012.097 0 4.015 4.015 0 011.816 1.093l.229.238H8.305a.541.541 0 00-.39.168.588.588 0 00-.162.407c0 .153.058.299.161.407a.541.541 0 00.39.168h3.125c.147 0 .287-.06.39-.168z"
				fill="#fff"
				stroke="#fff"
				strokeWidth={0.2}
			/>
	...
	return (
		<svg width={14} height={15} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M.6 7.1C.6 3.926 3.552 1.5 7 1.5c3.448 0 6.4 2.426 6.4 5.6 0 3.173-2.952 5.6-6.4 5.6-.403 0-.805-.033-1.203-.099a4.78 4.78 0 01-3.148.886.6.6 0 01-.467-.915c.262-.422.406-.907.417-1.404C1.383 10.16.6 8.72.6 7.1z"
				fill="#fff"
			/>
		</svg>
	);
...
export const ExternalWindow = (props) => {
	return (
