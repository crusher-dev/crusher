const CopyIconSVG = (props: any) => {
	return (
		<svg width={14} height={14} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<path
				d="M8.167 4.667H2.333c-.643 0-1.166.523-1.166 1.167v5.833c0 .643.523 1.167 1.166 1.167h5.834c.643 0 1.166-.524 1.166-1.167V5.834c0-.644-.523-1.167-1.166-1.167Z"
				fill="#fff"
				fillOpacity={0.42}
			/>
			<path
				d="M11.667 1.167H5.833a1.167 1.167 0 0 0-1.166 1.167V3.5h4.666A1.167 1.167 0 0 1 10.5 4.667v4.667h1.167a1.167 1.167 0 0 0 1.166-1.167V2.334a1.167 1.167 0 0 0-1.166-1.167Z"
				fill="#fff"
				fillOpacity={0.42}
			/>
		</svg>
