...
interface ITestIntegrationListProps {
    className?: string;
};

function TestIntegrationList(props: ITestIntegrationListProps) {
    ...
    return (
        <div  {...props} >
            <ExpandableList css={listStyle} currentSelected={selected} changeSelected={handleChangeItem}>
                                    ...
                                    <div className={"ml-70"}>
                                        <Button onClick={() => { }} size="medium">
                                            <div className={"flex items-center justify-center"}>
                                                <AppleSVG variant={"white"} className={"mr-12"} /><span className={"mt-2"}>Download dmg</span>
                                            </div>
                                        </Button>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div className={"ml-70"}>
                                        <Button bgColor={"tertiary-dark"} onClick={() => { }} size="medium">
                                            <div className={"flex items-center justify-center"}>
                                                <PlaySVG className={"mr-12"} /><span className={"mt-2"}>Create a test</span>
                                            </div>
                                        </Button>
                                    </div>
                                </td>
                ...
                <ExpandableListItem title="Integrate in your worflow" completed={false}>
                </ExpandableListItem>
            ...
            <div className={"flex flex-row mt-30"}>
                ...
                <div className={"ml-auto flex items-center"}>
                    <span css={checkoutProjectStyle} className={"text-13 mr-12"}>Or checkout <u className={"text-13 mr-0"}>Demo Project</u></span>
