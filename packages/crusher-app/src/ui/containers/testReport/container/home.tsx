...
export function HomeSection() {
	return (
		<div className={"mt-20 flex-col"} css={container}>
			<Terminal />

			<div css={buildContainerWidth} className="mx-auto mt-24">
				<div>
					<TextBlock weight={500} className="mb-12" fontSize={14}>
						Environment
					</TextBlock>
					<TextBlock color="#CECECE" fontSize={13}>
						Run at Circle Ci
					</TextBlock>
				</div>
			</div>
...
const progressBar = css`
	width: 100%;
	background: linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), linear-gradient(0deg, rgba(0, 0, 0, 0.74), rgba(0, 0, 0, 0.74)),
		#0f1317;
	border-radius: 8px;
	height: 7px;
			...
			<div css={report} className="mt-36 flex flex-col justify-between">
				<div>
					<div css={topBar} className="flex items-center justify-between px-26">
						<TextBlock weight={500} fontSize={14} color={"#D1D1D1"}>
							Build logs
						</TextBlock>
						<TextBlock fontSize={12} color={"#7c7c7c"}>
							why this error?
						</TextBlock>
					</div>
					<div className="px-32 mt-24">
						<div css={progressBar} className="mb-32">
							...
							<div id="progress-item" className="pt-12">
								90%done
							</div>
						</div>
						...
						<div>
							<div className="flex mb-32 items-center">
								...
								<TextBlock weight={400} fontSize={14} color={"#707070"}>
									Starting your test 🪄
								</TextBlock>
							</div>
						</div>
