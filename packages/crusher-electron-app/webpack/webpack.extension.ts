...
let finalConfig: any = {
	...
	plugins: [
		...
		new webpack.DefinePlugin({
			...
			"process.env": {
				BACKEND_URL: JSON.stringify(process.env.BACKEND_URL || "https://backend.crusher.dev/"),
				FRONTEND_URL: JSON.stringify(process.env.FRONTEND_URL || "https://app.crusher.dev/"),
			},
		}),
	],
	output: {
