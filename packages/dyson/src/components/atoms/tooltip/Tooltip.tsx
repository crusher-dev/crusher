...
import React, { ReactElement, useState, useEffect, SyntheticEvent, useCallback } from "react";
...
export const Tooltip: React.FC<TooltipWrapperProps> = ({ children, autoHide = "true", placement, type, content, padding = 0, ...props }) => {
	...
	const { offset: offsetWrapper = 5, css, wrapperCSS, callback } = props;
