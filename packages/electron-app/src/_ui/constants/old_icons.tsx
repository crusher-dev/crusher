...
const LogoV2 = (props) => {
	return (
		<svg width={23} height={24} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			/>
			<path
				d="M3.939 7.948a.431.431 0 00-.489.428v5.49c0 .26.23.461.489.427l3.964-.532a.431.431 0 00.374-.428V8.908a.431.431 0 00-.374-.428l-3.964-.532zM14.194 16.6h-3.588a.288.288 0 00-.288.288V23.2c0 .159.13.287.288.287h3.588a.287.287 0 00.287-.287v-6.313a.288.288 0 00-.287-.288z"
				fill="#fff"
			/>
			<path
				d="M19.97 15.2c-.14-4.274-2.847-7.317-6.18-7.317h-2.869a.287.287 0 00-.09.015l-1.704.567a.287.287 0 00-.196.273v4.848c0 .08.033.155.091.21l1.089 1.015a.57.57 0 01.208.454v2.043c0 .159.129.288.288.288h3.59a.287.287 0 00.288-.288v-2.173c0-.054 0-.153.04-.221.016-.028.037-.052.052-.08l.394-.735c.139-.259.347-.388.624-.388 1.528.064 2.986.582 4.097 1.618.148.166.277.075.277-.13z"
				fill="#fff"
			/>
		</svg>
	);
