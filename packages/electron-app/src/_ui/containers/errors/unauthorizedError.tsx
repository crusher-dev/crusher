			...
			<div css={containerStyle}>
				<div css={contentContainerStyle}>
					...
					<div css={descriptionStyle}>
						You don't have authorization to access this resource.<br />
						<div css={css`display: flex; gap: 20rem;`}>
							<NormalButton onClick={handleAccountInfo} css={accountInfoButtonCss}>Account Info</NormalButton>
							<NormalButton onClick={handeLogout} css={logoutButtonCss}>Logout</NormalButton>
						</div>
					</div>
				</div>
			</div>
