...
const GithubIconV2 = (props) => (
	...
	>
	  <path
		d="M14.5 0C6.492 0 0 6.492 0 14.5 0 22.509 6.492 29 14.5 29S29 22.509 29 14.5C29 6.492 22.508 0 14.5 0Zm4.062 25.546c-.084-1.134-.177-2.54-.183-3.11-.036-.436-.083-1.547-1.138-2.257 4.188-.35 6.18-2.665 6.324-5.723.12-1.742-.573-3.274-1.802-4.51.062-1.322-.04-2.889-.125-3.578-.945-.272-3.147.891-3.762 1.389-1.298-.504-4.474-.68-6.405 0-1.368-.963-2.926-1.557-3.775-1.391-.784 1.737-.28 3.379-.127 3.575-1.01.922-2.418 2.058-2.035 4.437.613 3.488 3.067 5.37 7.018 5.83-.842.172-.985.8-1.055 1.074-2.654 1.094-3.412-.677-3.748-1.138-1.113-1.378-2.113-.978-2.175-.957-.06.022-.105.109-.099.15.057.298.663.6.693.624.822.613 1.126 1.72 1.314 2.035 1.179 1.938 3.92 1.134 3.946 1.15.002.17-.02 1.596-.036 2.707C6.395 24.488 2.72 19.929 2.72 14.5c0-6.507 5.274-11.781 11.78-11.781 6.508 0 11.782 5.274 11.782 11.781 0 5.078-3.217 9.39-7.72 11.046Z"
		fill="#fff"
	  />
	</svg>
  )
