...
import { Link, ModelContainerLayout } from "../../_ui/ui/layout/modalContainer";
...
const DeveloperInput = () => {
    ...
    top: 13px; :hover { opacity: 0.8 }`} />
            ...
            <div css={[noteCss, css`font-size: 14px; padding-left: 2px; margin-top: 10px;`]}>Run in git repo</div>
        </div>
    );
}
