import {MONGODB} from "../../../crusher-shared/config/database";
...
export default class MongoManager{
    ...
    init(){
        ...
        const connectionString = MONGODB.connectionString ? MONGODB.connectionString : `mongodb://${MONGODB.username}:${MONGODB.password}@${MONGODB.host}:${MONGODB.port}/${MONGODB.database}`
