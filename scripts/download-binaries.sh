...
curl -u $GA_CLIENT_ID:$GA_CLIENT_SECRET -L --retry 3 --max-time 900 --connect-timeout 60 -s https://api.github.com/repos/crusher-dev/celectron-releases/releases/latest 
